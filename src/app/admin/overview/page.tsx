...
export default function AdminOverviewPage() {
  ...
  const maxChallenge = data
    ? Math.max(...data.topChallenges.map((c) => c.count), 1)
    : 1;
  const topLga =
    data && data.map.length ? [...data.map].sort((a, b) => b.c - a.c)[0] : null;
  ...
  return (
    ...
    >
      ...
      {data && (
        ...
        >
          <div
            className="sr-admin-overview-layout"
            style={{
              display: "grid",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              >
                {[
                  {
                    label: "Respondents",
                    value: data.kpis.totalRespondents.toLocaleString(),
                    tone: "var(--c-gold)",
                  },
                  {
                    label: "Communities",
                    value: data.kpis.communities,
                    tone: "var(--c-dark-text)",
                  },
                  {
                    label: "LGAs",
                    value: data.kpis.lgas,
                    tone: "var(--c-dark-text)",
                  },
                  {
                    label: "Women",
                    value: data.kpis.women.toLocaleString(),
                    tone: "var(--c-magenta)",
                  },
                  {
                    label: "Men",
                    value: data.kpis.men.toLocaleString(),
                    tone: "var(--c-dark-text)",
                    hint: "allies · sponsors",
                  },
                ].map((k) => (
                  <div
                    key={k.label}
              ...
              <div
                className="sr-admin-overview-lower"
                style={{
                  display: "grid",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      n = {data.kpis.totalRespondents.toLocaleString()}
                    </div>
                  </div>
                  <div
                    style={{
                    ...
                    {[
                      {
                        ...
                        v: data.momentum.participantsCount,
                        big: true,
                      },
                      {
                        l: "Active streaks (7d+)",
                        v: data.momentum.activeStreaks,
                      },
                      {
                        l: "Avg. streak length",
                        v: `${data.momentum.avgStreak}d`,
                      },
                    ].map((s, i) => (
                      <div
                        key={s.l}
                        style={{
                          ...
                          paddingBottom: 10,
                          borderBottom:
                            i < 2 ? "1px dashed var(--c-dark-border)" : "none",
                        }}
                      >
                        <div>
                          <div
                          ...
                          <div
                            style={{ fontSize: 11, color: soft, marginTop: 2 }}
                          >
                            {s.l}
                          </div>
                        </div>
                  ...
                  {topLga && (
                    <div
                      style={{
                        ...
                        background: "rgba(212,48,110,0.12)",
                    ...
                    >
                      ...
                      <div
                        style={{ marginTop: 4, fontSize: 12, lineHeight: 1.4 }}
                      >
                        {topLga.lga} leads with {topLga.c} respondents. Consider
                        a case study.
                      </div>
                    </div>
                  )}
