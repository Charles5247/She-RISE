// Nigeria's 36 states + the Federal Capital Territory, each with its full
// list of Local Government Areas (774 LGAs total, per NBS/INEC official
// administrative divisions). Used to populate the admin LGA filter/target
// dropdowns nationally.
//
// NOTE: this is deliberately separate from the pilot LGA list in
// src/lib/seed.ts. The seed data intentionally scopes the demo/pilot to a
// 6-LGA Ondo Central cluster — that scoping is correct and unrelated to
// this file. This file exists so admin screens can filter/target/view by
// ANY real Nigerian LGA, not just the ones the pilot happens to have seed
// data for.
...
export const NIGERIA_STATES: NigeriaState[] = [
  ...
  },
  {
    ...
    lgas: [
      ...
      "Etsako Central", "Etsako East", "Etsako West", "Igueben", "Ikpoba Okha",
      "Orhionmwon", "Oredo", "Ovia North-East", "Ovia South-West", "Owan East",
  ...
  },
  {
    ...
    lgas: [
      ...
      "Minjibir", "Nasarawa", "Rano", "Rimin Gado", "Rogo", "Shanono", "Sumaila", "Takai",
